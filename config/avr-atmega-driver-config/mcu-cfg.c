...
GPIO_Config()
{
  ...
  DDRC    =    _O_(7)| _O_(6)| _O_(5)| _O_(4)| _O_(3)| _O_(2)| _I_(1)| _I_(0)  ; 
  ...
  PORTC   =    _L_(7)| _L_(6)| _L_(5)| _L_(4)| _L_(3)| _L_(2)| _H_(1)| _H_(0)  ;
...
EXTERNAL_INTERRUPT_config(void)
{
  ...
  PCMSK1  =            _L_(6)| _L_(5)| _L_(4)| _L_(3)| _L_(2)| _H_(1)| _H_(0)  ;
